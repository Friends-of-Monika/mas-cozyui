<!-- Settings check/radio row: a 28px box + label from the real theme assets.
     Selected/hovered rows get the filled check foreground and a 9-sliced rounded
     background. "Change Renderer" is a plain text button (no box). The label
     uses the option font (check_button_text / radio_button_text -> CUI_OPTION_FONT). -->
<script lang="ts">
