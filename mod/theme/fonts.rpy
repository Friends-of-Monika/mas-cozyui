...
# Definitions
################################################################################
define gui.default_font = cozy_ui.common.font
...
init 999 style game_menu_label_text:
    font    cozy_ui.menu_font
    kerning cozy_ui.menu_font_kerning
    size    cozy_ui.menu_title.font_size
...
init 999 style pref_label_text:
    font    cozy_ui.menu_font
    kerning cozy_ui.menu_font_kerning
    size    cozy_ui.menu_label.font_size
...
init 999 style main_menu_version:
    ...
    size    cozy_ui.menu_text.font_size
...
init 999 style navigation_button_text:
    font    cozy_ui.menu_font
    kerning cozy_ui.menu_font_kerning
    size    cozy_ui.menu_button_text.font_size
...
init 999 style music_menu_button_text:
    font    cozy_ui.music_menu_button_text.font
    kerning cozy_ui.music_menu_button_text.font_kerning
    size    cozy_ui.music_menu_button_text.font_size
...
init 999 style normal:
    font         cozy_ui.common.font
    kerning      cozy_ui.common.font_kerning
    yoffset      cozy_ui.dialogue_text.vertical_offset
    line_spacing cozy_ui.dialogue_text.line_spacing

# Quick button
init 999 style quick_button_text:
    font    cozy_ui.common.font
    kerning cozy_ui.common.font_kerning
    size    cozy_ui.quick_button_text.font_size
...
init 999 style choice_button:
    top_padding    (5 + int(math.floor(float(cozy_ui.button.height_adjustment) / 2.0)))
    bottom_padding (5 + int(math.ceil (float(cozy_ui.button.height_adjustment) / 2.0)))
